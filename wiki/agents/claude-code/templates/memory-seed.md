...
Honest reporting: bad results, contradicted claims, and worsened metrics get filed truthfully. Per the project's CLAUDE.md and global instructions, never report accuracy from projections, only from real script outputs.
